...
let two_squared_squared = square (square 2)
</oxcaml>
...
let even x = x % 2 = 0
let sum_odd_and_even = sum_if_true even 3 4
let sum_two_evens = sum_if_true even 2 4
</oxcaml>
...
Continue to the [next page](./tour-of-ocaml-01.md).
